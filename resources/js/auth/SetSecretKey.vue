    ...
    <div class="cf mt4 mw7 center br3 mb3 bg-white box">
      <div class="fn fl-ns w-50-ns pa3">
        ...
        <form @submit.prevent="submit">
          <!-- Email -->
          <div class="">
            <label class="db fw4 lh-copy f6" for="secret">Set secret key</label>
            <input v-model="form.secret" type="secret" name="secret" class="br2 f5 w-100 ba b--black-40 pa2 outline-0" required />
          </div>
